...
export const metadata = {
  title: 'Cat Vaccination in Gurugram | TruVet Pet Care, Sector 79',
  description:
    'Cat and kitten vaccination at TruVet Pet Care Clinic, Sector 79 Gurugram. FVRCP, rabies and more. Dr. Brajmadhuri, open all 7 days.',
};
...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      '@type': 'FAQPage',
      mainEntity: [
        { '@type': 'Question', name: 'Do indoor cats need vaccines?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Several diseases spread through air or indirect contact, so indoor cats remain at risk. Vaccination is recommended for all cats.' } },
        { '@type': 'Question', name: 'When should I get my kitten vaccinated?', acceptedAnswer: { '@type': 'Answer', text: 'The first vaccine is typically given at 8 to 9 weeks. Dr. Brajmadhuri will advise the full schedule at the first visit.' } },
        { '@type': 'Question', name: 'How often do adult cats need boosters?', acceptedAnswer: { '@type': 'Answer', text: 'Most core vaccines are given annually. Dr. Brajmadhuri will advise based on your cat\'s age, health and history.' } },
      ],
    },
  ],
};

const vaccines = ['Feline Panleukopenia', 'Feline Herpesvirus', 'Calicivirus (FVRCP)', 'Rabies'];
const trustPoints = [
...
const faqs = [
  { q: 'Do indoor cats need vaccines?', a: 'Yes. Several diseases spread through air or indirect contact, so indoor cats remain at risk. Vaccination is recommended for all cats.' },
  { q: 'When should I get my kitten vaccinated?', a: 'The first vaccine is typically given at 8 to 9 weeks. Dr. Brajmadhuri will advise the full schedule at the first visit.' },
  { q: 'How often do adult cats need boosters?', a: 'Most core vaccines are given annually. Dr. Brajmadhuri will advise based on your cat\'s age, health and history.' },
];
    ...
    <>
      ...
      <section className="bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-10 pb-16 md:pb-20">
          <nav className="flex items-center gap-1.5 text-xs mb-8" style={{ color: '#6b7280', fontWeight: 300 }}>
            ...
            <span style={{ opacity: 0.4 }}>/</span>
            <span>Cat Vaccination</span>
          </nav>
          <div className="flex flex-col gap-5 max-w-2xl">
            <span className="self-start text-xs font-semibold uppercase tracking-widest px-3 py-1 rounded-full" style={{ backgroundColor: 'rgba(217,79,30,0.08)', color: '#d94f1e' }}>Cat Vaccination</span>
            <h1 className="text-4xl md:text-5xl leading-tight" style={{ color: '#1a3050' }}>Cat Vaccination in <em style={{ color: '#d94f1e', fontStyle: 'italic' }}>Gurugram</em></h1>
            <p className="text-base leading-relaxed" style={{ color: '#6b7280', fontWeight: 300 }}>Core vaccines for kittens and adult cats, administered by Dr. Brajmadhuri personally.</p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-20 flex flex-col gap-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg p-7 flex flex-col gap-4" style={{ border: '1px solid rgba(0,0,0,0.07)' }}>
              <span className="text-xs font-semibold uppercase tracking-widest" style={{ color: '#d94f1e' }}>Why Vaccinate Your Cat</span>
              <h2 className="text-2xl" style={{ color: '#1a3050' }}>Indoor cats need <em style={{ color: '#d94f1e', fontStyle: 'italic' }}>vaccines too.</em></h2>
              <ul className="flex flex-col gap-3">
                {['Indoor cats still exposed through air and indirect contact', 'Protects against airborne and contact-spread diseases', 'Essential before boarding or travel'].map(item => (
            ...
            <div className="bg-white rounded-lg p-7 flex flex-col gap-4" style={{ border: '1px solid rgba(0,0,0,0.07)' }}>
              <span className="text-xs font-semibold uppercase tracking-widest" style={{ color: '#d94f1e' }}>Kitten Schedule</span>
              <h2 className="text-2xl" style={{ color: '#1a3050' }}>Starting at <em style={{ color: '#d94f1e', fontStyle: 'italic' }}>8 to 9 weeks.</em></h2>
              <p className="text-sm leading-relaxed" style={{ color: '#6b7280', fontWeight: 300 }}>The first vaccine is typically given at 8 to 9 weeks of age. Dr. Brajmadhuri will advise the complete schedule at your kitten's first visit based on age and health.</p>
            </div>
          </div>
      ...
      <section className="bg-white">
        <div className="max-w-xl mx-auto px-4 sm:px-6 py-14 text-center flex flex-col items-center gap-4">
          <h2 className="text-2xl md:text-3xl" style={{ color: '#1a3050' }}>Vaccinate your cat <em style={{ color: '#d94f1e', fontStyle: 'italic' }}>today.</em></h2>
