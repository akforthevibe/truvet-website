...
export const metadata = {
  title: 'Cat Health Checkup in Gurugram | TruVet Pet Care, Sector 79',
  description:
    'Cat health checkups at TruVet Pet Care Clinic, Sector 79 Gurugram. Kittens, adults and seniors. Dr. Brajmadhuri, open all 7 days.',
};
...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      '@type': 'FAQPage',
      mainEntity: [
        { '@type': 'Question', name: 'How often should my cat have a checkup?', acceptedAnswer: { '@type': 'Answer', text: 'Once a year for healthy adult cats. Senior cats over 7 years and kittens benefit from visits every 6 months.' } },
        { '@type': 'Question', name: 'My cat stays indoors. Does she still need a checkup?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Indoor cats can develop dental disease, obesity, kidney issues and other conditions that are best caught early through regular checkups.' } },
        { '@type': 'Question', name: 'Cats are hard to bring to the vet. Any advice?', acceptedAnswer: { '@type': 'Answer', text: 'Carrier training at home helps significantly. Dr. Brajmadhuri and the team at TruVet are experienced with anxious cats and keep the environment calm.' } },
      ],
    },
  ],
};

const checkupCovers = ['Weight and body condition assessment', 'Eyes, ears and dental health', 'Skin and coat evaluation', 'Heart and lung auscultation', 'Abdominal palpation', 'Dental health review', 'Vaccination and deworming status'];
const trustPoints = [
...
const faqs = [
  { q: 'How often should my cat have a checkup?', a: 'Once a year for healthy adult cats. Senior cats over 7 years and kittens benefit from visits every 6 months.' },
  { q: 'My cat stays indoors. Does she still need a checkup?', a: 'Yes. Indoor cats can develop dental disease, obesity, kidney issues and other conditions that are best caught early through regular checkups.' },
  { q: 'Cats are hard to bring to the vet. Any advice?', a: 'Carrier training at home helps significantly. Dr. Brajmadhuri and the team at TruVet are experienced with anxious cats and keep the environment calm.' },
];

export default function CatHealthCheckupPage() {
  return (
    <>
      ...
      <section className="bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-10 pb-16 md:pb-20">
          <nav className="flex items-center gap-1.5 text-xs mb-8" style={{ color: '#6b7280', fontWeight: 300 }}>
            ...
            <span style={{ opacity: 0.4 }}>/</span>
            <span>Cat Health Checkup</span>
          </nav>
          <div className="flex flex-col gap-5 max-w-2xl">
            <span className="self-start text-xs font-semibold uppercase tracking-widest px-3 py-1 rounded-full" style={{ backgroundColor: 'rgba(217,79,30,0.08)', color: '#d94f1e' }}>Cat Health Checkup</span>
            <h1 className="text-4xl md:text-5xl leading-tight" style={{ color: '#1a3050' }}>Cat Health Checkup in <em style={{ color: '#d94f1e', fontStyle: 'italic' }}>Gurugram</em></h1>
            <p className="text-base leading-relaxed" style={{ color: '#6b7280', fontWeight: 300 }}>Cats hide illness well. Regular checkups with Dr. Brajmadhuri help catch problems before they become serious.</p>
      ...
      <section style={{ backgroundColor: '#fdf0e8' }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-20 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white rounded-lg p-7 flex flex-col gap-4" style={{ border: '1px solid rgba(0,0,0,0.07)' }}>
            ...
            <h2 className="text-2xl" style={{ color: '#1a3050' }}>A full exam, <em style={{ color: '#d94f1e', fontStyle: 'italic' }}>nothing skipped.</em></h2>
          ...
          <div className="bg-white rounded-lg p-7 flex flex-col gap-4" style={{ border: '1px solid rgba(0,0,0,0.07)' }}>
            ...
            <h2 className="text-2xl" style={{ color: '#1a3050' }}>Earlier is always <em style={{ color: '#d94f1e', fontStyle: 'italic' }}>better.</em></h2>
            <ul className="flex flex-col gap-3">
              {['Annually for healthy adult cats', 'Every 6 months for senior cats over 7 years', 'Every 6 months for kittens in their first year', 'Any time behaviour, appetite or litter habits change'].map(item => (
                <li key={item} className="flex items-start gap-3">
                  <span className="mt-1 w-1.5 h-1.5 rounded-full flex-shrink-0" style={{ backgroundColor: '#d94f1e' }} />
                  <span className="text-sm leading-relaxed" style={{ color: '#6b7280', fontWeight: 300 }}>{item}</span>
                </li>
      ...
      <section className="bg-white">
        <div className="max-w-xl mx-auto px-4 sm:px-6 py-14 text-center flex flex-col items-center gap-4">
          <h2 className="text-2xl md:text-3xl" style={{ color: '#1a3050' }}>Book your cat's <em style={{ color: '#d94f1e', fontStyle: 'italic' }}>checkup.</em></h2>
